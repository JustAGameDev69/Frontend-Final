...
export default function PcFilter({ products = [], setProductss }) {
  const [
    { priceFilter, cpuFilter, vgaFilter, ramFilter, ssdFilter },
    dispatch,
  ...
  }, [ramFilter, vgaFilter, cpuFilter, ssdFilter, priceFilter, products]);
